...
from ayon_unreal.api.plugin import UnrealAssetCreator

from ayon_core.pipeline.create import CreatorError

from ayon_core.lib import UILabelDef, UISeparatorDef, BoolDef, NumberDef, EnumDef
...
class CreateRender(UnrealAssetCreator):
    ...
    def update_instance(self, instance, instance_data, pre_create_data):
        instance_data["label"] = (
            f'instance_data.get("folderPath") - {instance_data.get("productName")}'
        )
        super().update_instance(instance, instance_data, pre_create_data)

    def create_with_new_sequence(self, product_name, instance_data, pre_create_data):
        ...
        seq_data = {
            ...
            "frame_range": (seq.get_playback_start(), seq.get_playback_end()),
        }
    ...
    def create_from_existing_sequence(
        ...
        for sel in selection:
            ...
            if pre_create_data.get("use_hierarchy"):
                ...
                asset_name = sel_path.replace("/Game/Ayon/Sequences/", "").split("/")[0]
            ...
            if selected_asset_path == master_seq or pre_create_data.get(
                "use_hierarchy"
            ):
                ...
                for seq in seq_data_list:
                    ...
                    for sub_seq in subscenes:
                        ...
                        curr_data = {
                            ...
                            "output": (
                                f"{seq.get('output')}/" f"{sub_seq_obj.get_name()}"
                            ),
                            "frame_range": (
    ...
    def create(self, product_name, instance_data, pre_create_data):
        ...
        instance_data["creator_attributes"]["render_target"] = pre_create_data.get(
            "render_target"
        )
        if pre_create_data.get("create_seq"):
            self.create_with_new_sequence(product_name, instance_data, pre_create_data)
        else:
    ...
    def get_pre_create_attr_defs(self):
        ...
        return [
            UILabelDef("Select a Level Sequence to render or create a new one."),
            BoolDef(
                "create_seq",
            ...
            EnumDef("render_target", items=rendering_targets, label="Render target"),
            EnumDef(
                "render_preset",
